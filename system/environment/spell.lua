  ...
  return setmetatable({
    ...
    __index = function(self, key)
      if self.unitID then
        ...
        dank.console.debug(4, 'spell', 'indigo', self.unitID .. '.spell(' .. self.spell .. ').' .. key .. ' = ' .. dank.format(result))
        return result
      end
      return false
    end,
    ...
    __unm = function(t)
      ...
      dank.console.debug(4, 'spell', 'indigo', t.unitID .. '.spell(' .. t.spell .. ').cooldown = ' .. dank.format(result))
      return result
    end
  })
end

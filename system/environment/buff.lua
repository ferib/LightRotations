...
function dank.environment.conditions.buff(unit)
  return setmetatable({
    ...
    __index = function(self, func)
      ...
      dank.console.debug(4, 'buff', 'green', self.unitID .. '.buff(' .. tostring(self.spell) .. ').' .. func .. ' = ' .. dank.format(result))
      return result
    end,
    ...
    __unm = function(t)
      ...
      dank.console.debug(4, 'buff', 'green', t.unitID .. '.buff(' .. tostring(t.spell) .. ').exists = ' .. dank.format(result))
      return result
    end
  })
end
